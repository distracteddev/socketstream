...
// Set root path of your projec
var pathlib = require('path');
var root = exports.root = process.mainModule.filename;
root = root.replace(pathlib.basename(root), "");
//console.log("RESOLVED", pathlib.resolve(root, 'union'));

//console.log(process.mainModule);
//console.log("ROOT: ", root);

if (process.env.SS_DIRECTORY) root = root + process.env.SS_DIRECTORY;
